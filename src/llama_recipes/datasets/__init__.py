...
from llama_recipes.datasets.pororo_dataset import InstructionDataset as get_pororo_dataset
from llama_recipes.datasets.vwp_dataset import InstructionDataset as get_vwp_dataset